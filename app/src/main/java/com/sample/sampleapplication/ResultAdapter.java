...
class ResultAdapter extends RecyclerView.Adapter<ResultAdapter.DatasetHolder> {
    ...
    public void updateDataset(List<String> updateDataset, ArrayList<String> updatedTagList) {
        imageList.clear();
        tagList.clear();
        tagList.addAll(updatedTagList);
        imageList.addAll(updateDataset);
